...
- **End-to-end — recall 0.0, precision 0.0, false-positive rate 1.0.** Run end-to-end through the offline heuristic extractor (`app/heuristic_extractor.py`, no network, no credentials), the system recovers 0 of 6 real plot holes: it produces only 4 contradiction candidates across 220 episodes, locates 3 of the 11 contradiction-class items — `twist-01`, `twist-02`, `twist-05`, all twists, none protected because their payoff links are missing or unverified — and misfires on all 3 clean controls.
